...
public class BookRecommendAdapter extends DefaultAdapter {

	public BookRecommendAdapter(List<Map<String, String>> list, Context context) {
		super(list, context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == 0 && bookMap.get("topTitle").equals("recommend")) {
