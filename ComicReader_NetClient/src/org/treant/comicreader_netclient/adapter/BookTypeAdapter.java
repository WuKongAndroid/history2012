...
public class BookTypeAdapter extends DefaultAdapter {

	public BookTypeAdapter(List<Map<String, String>> list, Context context) {
		super(list, context);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == 0 && bookMap.get("topTitle").equals("type")) {
